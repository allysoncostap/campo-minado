...
import br.com.allysoncostap.cm.excecao.ExplosaoException;
import br.com.allysoncostap.cm.excecao.SairException;
	...
	private void cicloDoJogo() {
		try {
			while (!tabuleiro.objetivoAlcancado()) {
				...
				digitado = capturarValorDigitado("1 - Abrir ou 2 -(Des)Macar");
